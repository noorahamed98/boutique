...
- `/welcome` -> send the greeting above
- `/price` -> `Please share the design screenshot or product name. We will confirm pricing and customization options for you.`
- `/size` -> `Please send your size or measurements. If needed, we will guide you step by step on WhatsApp.`
